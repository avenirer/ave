...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-9">
			<h1>Users without groups attached</h1>
			<?php
			echo '<p>'.anchor('users/add_user','<i class="fa fa-user"></i> Add user','class="btn btn-primary btn-sm"').'&nbsp;'.anchor('users/get_users','<i class="fa fa-group"></i> All users','class="btn btn-info btn-sm"').'</p>';
			if(!empty($users))
			{
